...
export const ResultsPagePagination: FC<ResultsPagePaginationProps> = ({ handlePagination }) => {
    ...
    return (
        ...
        <button className={`${page === 0 ? 'bg-gray-300 opacity-50' : 'hover:bg-gray-200 active:bg-gray-400'} px-4 py-2 rounded-md`} onClick={handlePrevious} disabled={page === 0 ? true : false}>Previous</button>
