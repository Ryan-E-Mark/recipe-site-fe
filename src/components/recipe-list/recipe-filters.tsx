    ...
    <div className="border-2 border-lime-200 rounded-md flex flex-col items-center">
      ...
      <div className="flex gap-x-4">
        <div className="">
          ...
          <div
            id="cuisine-dropdown"
            className="z-10 hidden w-48 bg-white divide-y divide-grazy-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600"
          >
            {/* {Object.keys(CUISINE_FILTERS).map((filter) => {
              return ( */}
                <ul>
